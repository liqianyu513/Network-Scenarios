...
nodes = {
    ...
    "C": m.NodeInfo(
        ...
        vulnerabilities=dict(
            CVE_2017_16995=m.VulnerabilityInfo(
                description='',
                type=m.VulnerabilityType.LOCAL,
                # outcome=[m.AdminEscalation(), m.LeakedNodesId(["D", "E", "F", "G", "H"])],
                outcome=m.LeakedNodesId(["A"]),
                # precondition=m.Precondition('True'),
                rates=m.Rates(probingDetectionRate=0.0,
                              exploitDetectionRate=0.0,
                              successRate=1.0),
    ...
    "D": m.NodeInfo(
        ...
        vulnerabilities=dict(
            MS15_015=m.VulnerabilityInfo(
                description='',
                type=m.VulnerabilityType.LOCAL,
                # outcome=[m.SystemEscalation(), m.LeakedNodesId(["C", "E", "F", "G", "H"])],
                outcome=m.LeakedNodesId(["B", "F"]),
                # precondition=m.Precondition('True'),
                rates=m.Rates(probingDetectionRate=0.0,
                              exploitDetectionRate=0.0,
                              successRate=1.0),
    ...
    "E": m.NodeInfo(
        ...
        value=100,
        properties=["Windows_7", "RDP", "Windows_10_10586"],
        # firewall=(),
        # agent_installed=False,
        # privilege_level=m.PrivilegeLevel.NotFound,
        # owned_string='',
    ...
    "H": m.NodeInfo(
        ...
        vulnerabilities=dict(
            CVE_2019_0708=m.VulnerabilityInfo(
                description='',
                type=m.VulnerabilityType.REMOTE,
                # outcome=[m.AdminEscalation(), m.LeakedNodesId(["C", "D", "E", "F", "G", "I"])],
                outcome=m.AdminEscalation(),
                rates=m.Rates(probingDetectionRate=0.0,
                              exploitDetectionRate=0.0,
                              successRate=1.0),
    ...
    "I": m.NodeInfo(
        ...
        vulnerabilities=dict(),
        value=600,
        properties=["Windows_Server_2008", "smb", "SSH"],
        # firewall=(),
        # agent_installed=False,
        # privilege_level=m.PrivilegeLevel.NotFound,
        # owned_string='',
